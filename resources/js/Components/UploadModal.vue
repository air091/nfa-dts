...
function generateTrackingNumber(unitName) {
    // Extract unit prefix (e.g., "CPMSD" from "CPMSD/DO")
    let unitPrefix = 'XXX';
    if (unitName) {
        // Remove /DO suffix and get the prefix
        unitPrefix = unitName.replace('/DO', '').trim().toUpperCase();
    }
    ...
    // Format: Unit-year-month-001-001 (will be generated by backend)
    // This is just a placeholder - backend will generate the actual number
    return `${unitPrefix}-DO-${yyyy}-${mm}-001-001`;
}
          ...
          <form @submit.prevent="handleSubmit">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input id="trackingCode" v-model="trackingCodeDisplay" type="text" readonly class="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100 cursor-not-allowed" :class="{ 'border-red-500': errors.trackingCode }" />
              ...
              <div>
                ...
                <input id="originatingOffice" v-model="formData.originatingOffice" type="text" readonly class="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100 cursor-not-allowed" :class="{ 'border-red-500': errors.originatingOffice }" />
